function SETfit()
    ...
    loadButton = uicontrol(fig, 'Style', 'pushbutton', 'String', 'Load', ...
    ...
    function updateMeasuredDataLimits()
        % Get the data
        ...
        % Uncheck all the fitting boxes
        fitCgCheckbox.Value = 0;
        fitCsCheckbox.Value = 0;
        fitCdCheckbox.Value = 0;
    end
    
    function redrawFittingLines()
        
        % Don't do anything unless the box is checked
